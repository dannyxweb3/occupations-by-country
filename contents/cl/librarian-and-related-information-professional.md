# Librarians and Related Information Professionals — career analysis · Chile
...
**Job demand: medium (★★½☆☆).** National workforce approx. 2,638.
...
**Q: What is the average salary for librarians in Chile?**
A: Librarians in Chile earn an average monthly salary between CLP 800,000 and CLP 1,200,000. Entry-level positions start around CLP 600,000, while experienced professionals or those in management can earn up to CLP 1,800,000. Salaries vary by sector, with private institutions often paying higher than public ones.

**Q: What is the job outlook for librarians in Chile?**
A: The job outlook is stable, with moderate growth in public libraries, universities, and specialized information centers. Digital transformation is creating demand for roles in digital curation and information management. Competition exists in major cities like Santiago, but opportunities remain steady in regional and rural areas.

**Q: How is AI impacting the librarian profession in Chile?**
A: AI is automating routine tasks like cataloging and metadata creation, allowing librarians to focus on user services and data analysis. In Chile, libraries are adopting AI for chatbots and personalized recommendations. Librarians need skills in digital literacy, data management, and AI tools to stay relevant.
...
🔗 **[Full detail on aijobrisk.com](https://aijobrisk.com/jobs/librarian-and-related-information-professional/CL)**
