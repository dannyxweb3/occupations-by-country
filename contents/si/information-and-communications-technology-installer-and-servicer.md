# Information and Communications Technology Installers and Servicers — career analysis · Slovenia
...
**Job demand: high (★★★★☆).** National workforce approx. 984.
...
**Q: What is the average salary for ICT Installers and Servicers in Slovenia?**
A: According to statistical data, the gross monthly salary for ICT installers and servicers in Slovenia typically ranges from €1,200 to €1,800, depending on experience and employer. Entry-level positions start around €1,000, while senior technicians can earn up to €2,200. These figures may vary by region and company size.

**Q: What are the official work visa routes for ICT Installers and Servicers to work in Slovenia?**
A: Non-EU nationals can work in Slovenia via the EU Blue Card (for highly qualified workers) or a single work permit. The Blue Card requires a valid job offer with a salary at least 1.5 times the average gross annual salary. Alternatively, employers can sponsor a work permit through the Employment Service of Slovenia, subject to labor market testing.

**Q: What qualifications are needed to become an ICT Installer and Servicer in Slovenia?**
A: A secondary vocational education in electronics, telecommunications, or IT is typically required. Many employers value practical experience and certifications (e.g., Cisco, CompTIA). Continuing education through short courses or apprenticeships is common. Slovenian language proficiency is often beneficial but not always mandatory.
...
🔗 **[Full detail on aijobrisk.com](https://aijobrisk.com/jobs/information-and-communications-technology-installer-and-servicer/SI)**
