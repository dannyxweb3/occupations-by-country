# Conference and Event Planners — career analysis · Slovenia
...
**Job demand: medium-high (★★★☆☆).** National workforce approx. 951.
...
**Q: What is the average salary for conference and event planners in Slovenia?**
A: The gross monthly salary for conference and event planners in Slovenia typically ranges from €1,500 to €2,500, depending on experience, employer, and project complexity. Entry-level roles start around €1,300, while senior planners with specialized skills can earn up to €3,000. Salaries are often supplemented by bonuses or commissions for large events.

**Q: What are the official work visa routes for foreign conference and event planners to work in Slovenia?**
A: Foreign nationals can work as conference and event planners in Slovenia via the EU Blue Card (for non-EU citizens with a university degree and a job offer meeting the salary threshold, at least 1.5 times the average gross annual salary) or a standard single work permit, which requires employer sponsorship and a positive opinion from the Employment Service of Slovenia.

**Q: What education or skills are required to become a conference and event planner in Slovenia?**
A: While no formal regulation exists, employers often prefer candidates with a degree in business, tourism, hospitality, or event management. Key skills include project management, negotiation, multilingual communication (Slovene and English), attention to detail, and proficiency in event software. Relevant experience through internships or junior roles is highly valued.
...
🔗 **[Full detail on aijobrisk.com](https://aijobrisk.com/jobs/conference-and-event-planner/SI)**
